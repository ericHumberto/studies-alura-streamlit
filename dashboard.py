...
receita_categorias = receita_categorias.sort_values(ascending=False)
...
fig_mapa_vendas.update_traces(hovertemplate='<b>%{hovertext}</b><br><br>Quantidade=%{marker.size}<extra></extra>')
